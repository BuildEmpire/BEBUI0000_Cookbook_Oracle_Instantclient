...
link "/usr/lib/oracle/#{node['cookbook_oracle_instantclient']['folder_name']}/libclntsh.so" do
  to "/usr/lib/oracle/#{node['cookbook_oracle_instantclient']['folder_name']}/libclntsh.so.#{node['cookbook_oracle_instantclient']['version']}"
end
